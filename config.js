...
//═══════[Required Variables]════════\\
process.env.OWNER_NUMBER = process.env.OWNER_NUMBER || '237651954407'
...
global.email = 'shirleywilliam715@gmail.com'
global.github = 'https://github.com/baezeus/CRAZY-MD'
global.location = 'Sultanpur IN'
global.gurl = 'https://instagram.com/' // add your username
global.sudo = process.env.SUDO || '237659958008'
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? '*𓅓∘̥⃟🌥️Justin ༆≛⃝🚬*' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? '𝑬. 𝑱𝒖𝒔𝒕𝒊𝒏🌥️' : process.env.OWNER_NAME,
  ...
  BRANCH: 'main', 
  ALIVE_MESSAGE:  process.env.ALIVE_MESSAGE === undefined ? 'Wesh le reuf, oublie pas que tu en mode gratos donc je risque sauter...' : process.env.ALIVE_MESSAGE,
